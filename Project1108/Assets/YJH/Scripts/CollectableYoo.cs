...
/// <summary>
/// 해당 클래스는 채집물 클래스 입니다. 최종 업데이트 {유준호 23/11/14}
/// <para>
/// <value name = "itemName"> itemName은 채집물의 이름입니다 미지정시 default로 설정됩니다. </value>
/// </para> <para>
/// <value name = "regenTime"> regenTime은 채집물의 재생성 시간입니다 미지정시 default로 설정됩니다. </value>
/// </para> <para>
/// <value name = "thisTransform"> thisTransform은 채집물의 트랜스폼입니다 미지정시 default로 설정됩니다. </value>
/// </para> <para>
/// <value name = "collectableScale"> collectableScale은 채집물의 채집 가능 크기입니다 미지정시 default로 설정됩니다. </value>
/// </para> <para>
/// <value name = "collectedScale"> collectedScale은 채집물의 채집 후 크기입니다. 미지정시 default로 설정됩니다. </value>
/// </para> <para>
/// <value name = "collectTime"> collectTime은 채집물 채집하는데 걸리는 시간입니다. 미지정시 default로 설정됩니다. </value>
/// </para> <para>
/// <value name = "state"> state는 채집물의 상태입니다. 미지정시 default로 설정됩니다. </value>
/// </para>
/// </summary>
